...
declare	-A bpms=( ["20180117"]="GSA-24v1-0_A2.bpm" ["20200110"]="GSA-24v2-0_A2.bpm" )
declare -A egts=( ["20180117"]="GSA-24v1-0_A1_ClusterFile.egt" ["20200110"]="GSA-24v2-0_A1_ClusterFile.egt" )
declare -A csvs=( ["20180117"]="GSA-24v1-0_A2.csv" ["20200110"]="GSA-24v2-0_A2.csv" )
declare -A sams=( ["20180117"]="" ["20200110"]="" )
...
mkdir -p /home/drew/Downloads/GoodCell-Resources/GuniosAnalysis/2018_07/Raw_Data/202136030091/gtcs
$HOME/bin/iaap-cli/iaap-cli gencall "$bpm" "$egt" gtcs -f /home/drew/Downloads/GoodCell-Resources/GuniosAnalysis/2018_07/Raw_Data/202136030091/gtcs/ -g
#/bin/rm *.idat
