...
export map=$REFDIR/GRCh38/genetic_map_hg38_withX.txt.gz
export cnp=$REFDIR/GRCh38/cnp.grch38.bed
export dup=$REFDIR/GRCh38/dup.grch38.bed.gz
export cyto=$REFDIR/GRCh38/cytoBand.hg38.txt.gz
