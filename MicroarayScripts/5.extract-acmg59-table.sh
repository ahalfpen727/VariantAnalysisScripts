...
###########################################################################
export ANALYSIS=/media/drew/easystore/GoodCell-Resources/AnalysisBaseDir
...
for pfx in 20180117 20200110; do
	...
	$RSCRIPT --illumina --vcf $wdir.clinvar.GRCh38.bcf --chrom $chr --pos $pos --id $id --png pngs/$wdir.$id.png
    done
done
